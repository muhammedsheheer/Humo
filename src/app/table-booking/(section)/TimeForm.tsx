    ...
    <div className="flex w-full flex-col items-center justify-center gap-3">
      ...
      <Form {...form}>
        ...
        >
                  ...
                  <Popover open={isPopoverOpen} onOpenChange={setIsPopoverOpen}>
                    <PopoverTrigger asChild>
                      <FormControl>
                        <Button
                          variant={"outline"}
                          className={`h-12 w-full justify-start border-[#fff] bg-transparent text-left font-normal text-[#fff] hover:bg-[#2222] hover:text-[#9C9E9F]`}
                        >
                ...
                {generateTimeSlots().map((time) => (
                  <div
                    ...
                    className={cn(
                      ...
                      form.watch("time") === time && "border-[#EB9A3F]",
                    )}
                  >
                    {time}
                  </div>
          ...
          <Button
            className="w-fit bg-[#EB9A3F] px-6 py-6 text-[#fff] hover:bg-[#e69c48]"
            disabled={disable}
          >
            Book A Table
          </Button>
