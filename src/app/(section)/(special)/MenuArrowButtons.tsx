...
export const PrevButton: React.FC<PropType> = (props) => {
  ...
  return (
    <Button
      ...
      size="icon"
      className={cn(
        "group/btn h-10 w-10 rounded-full border-0 border-[#662200] bg-transparent text-[#662200] hover:bg-primary",
    ...
    >
      ...
      />
      <ArrowLeftIcon className="h-5 w-5 text-[#662200]" />
...
export const NextButton: React.FC<PropType> = (props) => {
  ...
  return (
    ...
    >
      ...
      />
      <ArrowRightIcon className="h-5 w-5 text-[#662200]" />
