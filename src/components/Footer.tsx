...
const Footer = ({}) => {
  return (
    <footer className="h-full w-full bg-[#EB9A3F] px-4 pt-12 lg:px-10 lg:pt-24">
      <div className="flex flex-col gap-4 md:gap-6">
        ...
        <div className="flex flex-col items-center justify-center gap-4 md:flex-row md:items-center md:justify-end md:gap-2">
          ...
          <div className="mr-28 hidden h-[100px] w-full border-r-[1px] border-r-[rgba(0,0,0,0.40)] md:block md:h-[200px] md:w-[10%]" />
